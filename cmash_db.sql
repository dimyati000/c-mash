...
--
-- Host: localhost:3306
-- Generation Time: Jul 05, 2022 at 12:16 AM
...
--
ALTER TABLE `tb_invoice`
  MODIFY `idInvoice` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tb_layanan`
  MODIFY `idLayanan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tb_pesanan`
--
ALTER TABLE `tb_pesanan`
  MODIFY `idPesanan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
