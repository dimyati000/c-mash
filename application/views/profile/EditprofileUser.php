      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="row mt-sm-4">
              ...
              <div class="col-12 col-md-12 col-lg-4">
                <div class="card">
                  <form action="<?php echo base_url() . 'Profil/update' ?>" method="post" novalidate="">
                    <div class="card-header">
                      <h4>Data Diri</h4>
                    </div>
                    <div class="card-body">
                  ...
                  <form method="post" class="needs-validation" novalidate="">
                    ...
                    <div class="card-body">  
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?= $user['nama_kendaraan'] ?>" required="">
                      </div>
                      <div class="form-group">
                        <label>Merk Kendaraan</label>
                        <input type="text" class="form-control" value="<?= $user['merk_kendaraan'] ?>" required="">
                      </div>
                      <div class="form-group">
                        <label>Type Kendaraan</label>
                        <input type="text" class="form-control" value="<?= $user['type_kendaraan'] ?>" required="">
                      </div>
                      <div class="form-group">
                        <label>Plat Nomor</label>
                        <input type="text" class="form-control" value="<?= $user['plat_nomor'] ?>" required="">
                      </div>
                    </div>
                    <div class="card-footer text-right">
